...
class RecepcionPuntoVentaService
{
    ...
    private function transferirDetalle(
        ...
        if ($insumoOrigen === null) {
            throw new \InvalidArgumentException('Producto de centro mayorista no encontrado.');
        }

        if (! $insumoOrigen->tieneStockSuficiente($cantidad)) {
            throw new \InvalidArgumentException(
                "Stock insuficiente en mayorista para «{$insumoOrigen->nombre}». Disponible: {$insumoOrigen->stock}."
            );
        }
        ...
        if ($insumoDestino === null) {
            ...
            $insumoDestino = Insumo::create([
                ...
                'descripcion' => 'Producto recibido desde centro mayorista — '.$pedido->numero_solicitud,
        ...
        AlmacenMovimiento::create([
            ...
            'observaciones' => '[Distribución PDV — salida mayorista] '.$ref,
        ]);
