...
final class MayoristaPedidoNotificacionVista
{
    public static function clavePedido(int $pedidoId): string
    {
    ...
    /**
     * @param  list<array{clave: string, codigo: string, url: string, producto: string, minorista: string, cantidad: string}>  $items
    ...
    {
        return 'mayorista_pedido_modal_vistas:'.$usuarioid;
    }
}
