...
Route::middleware(['auth', 'cuenta.aprobada'])->group(function () {
    ...
    Route::prefix('almacen-mayorista/traslados-planta')->name('almacen-mayorista.traslados-planta.')->group(function () {
        ...
        Route::get('/{ruta}', [\App\Http\Controllers\Web\TrasladoPlantaMayoristaController::class, 'show'])
            ...
            ->whereNumber('ruta')
            ->middleware('action.permission:inventario,read');
        Route::patch('/{ruta}/aceptar', [\App\Http\Controllers\Web\TrasladoPlantaMayoristaController::class, 'aceptar'])
            ->name('aceptar')
            ->whereNumber('ruta')
            ->middleware('action.permission:inventario,update');
        Route::patch('/{ruta}/rechazar', [\App\Http\Controllers\Web\TrasladoPlantaMayoristaController::class, 'rechazar'])
            ->name('rechazar')
            ->whereNumber('ruta')
            ->middleware('action.permission:inventario,update');
    });
    ...
    Route::prefix('punto-venta')->name('punto-venta.')->group(function () {
        ...
        Route::patch('pedidos/{pedido}/empezar-ruta', [PedidoDistribucionController::class, 'empezarRuta'])->name('pedidos.empezar-ruta')->middleware('action.permission:pedidos_distribucion,update');
