...
Route::middleware('auth')->group(function () {
    ...
    // Almacenes — create/store va ANTES que index/show para que /almacenes/create
    // no sea capturado por el parámetro wildcard {almacen}
    ...
    // Producciones almacenamiento — mismo fix de orden
