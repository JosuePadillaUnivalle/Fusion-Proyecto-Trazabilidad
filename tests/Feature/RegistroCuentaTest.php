...
class RegistroCuentaTest extends TestCase
{
    ...
    public function test_registro_mayorista_crea_solicitud_pendiente(): void
    {
        $response = $this->post(route('register.post'), [
            'nombre' => 'Carlos',
            'apellido' => 'Mayorista',
            'email' => 'carlos.mayorista@test.local',
            'telefono' => '+591 73334444',
            'ci_nit' => '7654321',
            'rol_solicitado' => 'mayorista',
            'carta_motivacion' => str_repeat('Gestionaré la distribución mayorista hacia puntos de venta. ', 2),
            'password' => 'secret123',
            'password_confirmation' => 'secret123',
        ]);
