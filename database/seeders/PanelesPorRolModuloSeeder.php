...
class PanelesPorRolModuloSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (Insumo::where('almacenid', AlmacenDemoReferencia::central()?->almacenid)->count() < 2) {
    ...
    private function resolveContext(): ?array
    {
        ...
        return [
            ...
            'alm_central' => AlmacenDemoReferencia::central(),
            'alm_planta' => AlmacenDemoReferencia::planta(),
            'alm_norte' => AlmacenDemoReferencia::norte(),
        ];
    }
