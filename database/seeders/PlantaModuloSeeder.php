...
class PlantaModuloSeeder extends Seeder
{
    ...
    private function seedProduccionAlmacenamientoPlanta(): void
    {
        ...
        $almCentral = AlmacenDemoReferencia::central();
        $almNorte = AlmacenDemoReferencia::norte();
        $almPlantaProc = AlmacenDemoReferencia::planta();
    ...
    private function seedLogisticaPlantaExtra(): void
    {
        ...
        $almPlanta = AlmacenDemoReferencia::planta();
