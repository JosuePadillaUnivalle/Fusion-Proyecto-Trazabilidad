...
class InventarioModuloSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $almacenCentral = AlmacenDemoReferencia::central();
        $almacenNorte = AlmacenDemoReferencia::norte();
        $almacenPlanta = AlmacenDemoReferencia::planta();

        if (! $almacenCentral) {
            $this->command?->error('No existe almacén demo central. Revise DemoUsuariosAlmacenesActoresSeeder.');
