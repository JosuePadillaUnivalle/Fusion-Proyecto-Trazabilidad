        ...
        <nav class="ag-sb-nav">
            <ul class="ag-nav-ul">
                ...
                @php
                    ...
                    $mayMenuOpen = request()->routeIs('almacen-mayorista.*', 'punto-venta.pedidos.*') && ! request()->routeIs('punto-venta.puntos.*', 'punto-venta.inventario.*');
                ...
                <li class="ag-nav-li">
                    ...
                    <ul class="ag-subnav {{ $envOpen ? 'open' : '' }}" id="sub-env">
                        ...
                        @endif
                        @if(! auth()->user()?->hasRole('transportista') && (auth()->user()?->can('asignaciones.read') || $isAdmin || \App\Support\UsuarioRol::esMayorista(auth()->user())))
                ...
                @php
                    $pvMenuOpen = request()->routeIs('punto-venta.puntos.*', 'punto-venta.inventario.*')
                        || (request()->routeIs('punto-venta.pedidos.*') && ($esMinoristaOperativo || $isAdmin));
                ...
                <li class="ag-nav-li">
                    ...
                    <ul class="ag-subnav {{ $mayMenuOpen ? 'open' : '' }}" id="sub-mayorista">
                        ...
                        <li class="ag-sub-li">
                            <a href="{{ route('punto-venta.pedidos.index') }}" class="ag-sub-a {{ request()->routeIs('punto-venta.pedidos.*') && !request()->routeIs('punto-venta.rutas.*') ? 'active' : '' }}">Pedidos minoristas</a>
                        </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="ag-nav-li">
                    ...
                    <ul class="ag-subnav {{ $pvMenuOpen ? 'open' : '' }}" id="sub-pv">
                        ...
                        @endif
                        @if($isAdmin && \App\Support\UsuarioRol::puedePlanificarDistribucion($authUser))
                        <li class="ag-sub-li">
