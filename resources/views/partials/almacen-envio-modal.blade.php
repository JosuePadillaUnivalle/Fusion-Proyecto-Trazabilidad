                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active p-3" id="{{ $modalId }}-lista" role="tabpanel">
                        ...
                        <p class="small text-muted mb-2">
                            ...
                            Pase el mouse sobre un almacén para ver la ocupación proyectada. Clic para elegir.
                        </p>
                    ...
                    <div class="tab-pane fade p-3" id="{{ $modalId }}-mapa" role="tabpanel">
                        <p class="small text-muted mb-2">
                            ...
                            Pase el mouse sobre un pin para ver capacidad y ocupación proyectada con esta cosecha. Clic para seleccionar.
                        </p>
