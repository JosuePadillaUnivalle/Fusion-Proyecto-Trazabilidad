                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        @include('lotes.partials.planificacion-cosecha', [
                            ...
                            'catalogoTamanoConteoId' => old('catalogotamanoconteoid', $lote->catalogotamanoconteoid ?? ''),
                        ])

                        @php $tieneSemillaEdit = (bool) old('insumosemillaid', $lote->insumosemillaid ?? ''); @endphp
                        <div id="superficieWrap" class="form-group {{ $tieneSemillaEdit ? '' : 'd-none' }}">
                            ...
                            <input type="number" step="0.01" name="superficie" id="superficie" class="form-control" min="0"
                                {{ $tieneSemillaEdit ? 'required' : '' }} value="{{ $lote->superficie }}">
                        </div>
