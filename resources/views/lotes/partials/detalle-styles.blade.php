<style>
    ...
    /* —— Cosecha estimada (planificación) —— */
    .lote-datos-panel__plan {
        background: linear-gradient(145deg, #f0fdf4 0%, #fff 55%, #f8fafc 100%);
    ...
    .lote-datos-panel__plan-header {
        display: flex;
        align-items: center;
        gap: .75rem;
        margin-bottom: .85rem;
    }
    .lote-datos-panel__plan-icon {
        width: 36px;
        height: 36px;
        border-radius: 10px;
        background: #fff;
    ...
    .lote-datos-panel__plan-subtitle {
        display: block;
        font-size: .72rem;
        color: #64748b;
        margin-top: .1rem;
    }
    .lote-datos-panel__plan-meta {
        display: flex;
        flex-wrap: wrap;
        gap: .4rem;
        margin-bottom: .75rem;
    }
    .lote-datos-panel__plan-tag {
        display: inline-flex;
        align-items: center;
        gap: .35rem;
        padding: .28rem .65rem;
    ...
    .lote-datos-panel__plan-tag--muted {
        color: #475569;
        background: rgba(255, 255, 255, .75);
        border-color: #e2e8f0;
        font-weight: 500;
    }
    .lote-datos-panel__plan-metrics {
        display: grid;
        grid-template-columns: repeat(3, 1fr);
        gap: .55rem;
        margin-bottom: .7rem;
    }
    .lote-datos-panel__plan-metric {
    ...
    .lote-datos-panel__plan-metric:hover {
        border-color: #86efac;
        box-shadow: 0 2px 10px rgba(44, 85, 48, .07);
    }
    .lote-datos-panel__plan-metric--highlight {
        background: linear-gradient(180deg, #fff, #f0fdf4);
        border-color: #86efac;
    }
    .lote-datos-panel__plan-metric-value {
        display: block;
        font-size: 1.08rem;
        font-weight: 800;
        color: #14532d;
    ...
    .lote-datos-panel__plan-metric-value small {
        font-size: .72rem;
        font-weight: 700;
        color: #64748b;
        margin-left: .1rem;
    }
    .lote-datos-panel__plan-metric-label {
        display: block;
        font-size: .66rem;
        text-transform: uppercase;
        letter-spacing: .04em;
    ...
    .lote-datos-panel__plan-footnote {
        display: flex;
    ...
    .lote-datos-panel__plan-footnote i {
        color: #22c55e;
        margin-top: .12rem;
        flex-shrink: 0;
    }
