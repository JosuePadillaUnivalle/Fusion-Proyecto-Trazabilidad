...
@section('content')
    ...
    <div class="row align-items-start">
            ...
            <div class="card pdv-card card-outline card-success mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="pdv-paso-panel" data-panel="2">
                        <div class="pdv-info-grid mb-0">
                            <div class="pdv-info-tile pdv-info-tile--wide">
                                <span class="pdv-info-tile__icon pdv-info-tile__icon--meta"><i class="fas fa-clipboard-check"></i></span>
                                <span class="pdv-info-tile__label">Estado de revisión</span>
                                <div class="pdv-info-tile__value">
                                    ...
                                    @elseif($pedido->fecha_aceptacion)
                                        ...
                                        @if($pedido->aceptadoPor)
                                            <span class="pdv-info-tile__sub d-block">por {{ trim($pedido->aceptadoPor->nombre.' '.$pedido->aceptadoPor->apellido) }}</span>
                                        @endif
                                    @else
                            ...
                            @if($det?->insumo)
                            <div class="pdv-info-tile">
                                <span class="pdv-info-tile__label">Stock verificado</span>
                                <div class="pdv-info-tile__value">{{ number_format((float) $det->insumo->stock, 2) }} {{ $unidad }}</div>
                                <span class="pdv-info-tile__badge {{ $stockOk ? 'pdv-info-tile__badge--ok' : 'pdv-info-tile__badge--bad' }}">
        ...
        <div class="col-lg-4" id="pdvPedidoSidebar">
            ...
            @else
            <div class="card pdv-card card-outline card-success mb-3">
                <div class="card-body small text-success mb-0">
                    <i class="fas fa-check-circle mr-1"></i> Revisión mayorista completada.
                </div>
            </div>
            @endif
            </div>
                ...
                <div class="card pdv-card card-outline card-secondary mb-3">
                    <div class="card-body small text-muted mb-0">
                        @if($transportistaDesignado && ($puedeGestionarMayorista ?? false) && $ruta && $pedido->estado === 'confirmado')
                            ...
                            Transportista asignado. Debe marcar <strong>en ruta</strong> desde su panel cuando el vehículo salga hacia el punto de venta.
                        @else
            ...
            <div class="card pdv-card card-outline card-secondary mb-3">
                <div class="card-body small text-muted mb-0">
                    @if($transportistaDesignado && ($puedeGestionarMayorista ?? false) && $pedido->estado === 'confirmado')
                        <i class="fas fa-truck mr-1"></i>
                        Transportista asignado. El chofer debe marcar <strong>en ruta</strong> cuando el vehículo salga hacia el punto de venta.
                    @else
