...
(function() {
    ...
    function actualizarRecomendacionMp() {
        ...
        texto.innerHTML =
            ...
            'Para <strong>' + formatoNumero(rec.und) + ' und</strong> de puré (' + PURE_CFG.pesoEnvaseG + ' g por envase, ' + PURE_CFG.rendimientoPct + '% rendimiento): ' +
            'use aprox. <strong>' + formatoNumero(rec.entradaKg) + ' kg</strong> de materia prima ' +
            '(salida estimada: ' + formatoNumero(rec.salidaKg) + ' kg).';
