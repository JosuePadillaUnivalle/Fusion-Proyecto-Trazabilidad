...
@php
    ...
    $modoProductoTerminado = $modoProductoTerminado ?? false;
    $urlRetorno = $urlRetorno ?? route('insumos.index');
    $iconoTipo = $modoProductoTerminado ? 'box-open' : match ($slugTipo) {
            ...
            <div class="card hero-card card-modulo-main mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        @if($modoProductoTerminado && $insumo->almacen)
                        <div class="col-md-6 mb-3">
                            <div class="dato-label">Almacén</div>
                            <div class="dato-valor">{{ $insumo->almacen->nombre }}</div>
                        </div>
                        @endif
                ...
                <div class="card-footer bg-white d-flex justify-content-between flex-wrap">
                    ...
                    <form action="{{ route('insumos.destroy', $insumo) }}" method="POST"
                          class="d-inline on-submit-confirm" data-confirm-title="¿Eliminar producto?" data-confirm-text="Se quitará este producto del inventario del almacén.">
                        @csrf
                        @method('DELETE')
