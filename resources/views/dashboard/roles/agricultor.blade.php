...
<style>.role-panel-wrap--agricultor { --rp-accent: #2c5530; }</style>
@endpush

@section('content')
<section class="content px-0 role-panel-wrap--agricultor">
    <div class="container-fluid px-0">
        ...
        <div class="role-metrics">
            ...
            <div class="role-metric dash-kpi--amber">
            ...
            <div class="role-metric dash-kpi--blue">
            ...
            <div class="role-metric dash-kpi--teal">
