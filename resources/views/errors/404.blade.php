...
<head>
    <meta charset="utf-8">
    <title>Página no encontrada | AgroNexus</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg-gradient {
            ...
            background:
                radial-gradient(ellipse 80% 60% at 20% 40%, rgba(5, 150, 105, 0.15) 0%, transparent 60%),
                radial-gradient(ellipse 60% 80% at 80% 70%, rgba(16, 185, 129, 0.06) 0%, transparent 60%);
        }
        .bg-grid {
            position: absolute; inset: 0;
        ...
        .orb-1 { width: 400px; height: 400px; background: rgba(16,185,129,.05); top: -100px; left: -80px; }
        .orb-2 { width: 350px; height: 350px; background: rgba(5,150,105,.07); bottom: -80px; right: -60px; animation-delay: -3s; }
        @keyframes float {
        ...
        .card {
            ...
            box-shadow: 0 0 0 1px rgba(16,185,129,.07), 0 32px 64px rgba(0,0,0,.5), inset 0 1px 0 rgba(255,255,255,.05);
            text-align: center;
        }
        .big-code { font-size: 5rem; font-weight: 800; color: rgba(16,185,129,.15); line-height: 1; margin-bottom: 8px; letter-spacing: -.04em; }
        .icon-wrap {
            width: 64px; height: 64px;
            background: linear-gradient(135deg, rgba(16,185,129,.15), rgba(5,150,105,.1));
            border: 1px solid rgba(16,185,129,.18); border-radius: 18px;
            display: flex; align-items: center; justify-content: center;
            margin: 0 auto 22px;
            box-shadow: 0 0 0 6px rgba(16,185,129,.07), 0 8px 24px rgba(16,185,129,.12);
        }
        .icon-wrap i { font-size: 1.6rem; color: #10b981; }
        .code {
        ...
        .btn-primary:hover { background: linear-gradient(135deg, #047857, #059669); box-shadow: 0 6px 20px rgba(16,185,129,.35); transform: translateY(-1px); }
...
<div class="card">
    ...
    <span class="code">404 &middot; No encontrado</span>
    <h1>Página no encontrada</h1>
    <p>La ruta que buscás no existe o fue movida.<br>Verificá la URL o volvé al dashboard.</p>
    <div class="btn-wrap">
