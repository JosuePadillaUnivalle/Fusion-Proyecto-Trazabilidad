...
<style>
.admin-home-wrap { --rp-accent: #2563eb; }
.admin-chart-card { margin-bottom: 1.25rem; }
...
<section class="content px-0 admin-home-wrap">
    <div class="container-fluid px-0">
        ...
        <div class="role-metrics">
            <a href="{{ route('lotes.index') }}" class="role-metric admin-metric--lotes dash-kpi--green text-decoration-none">
            ...
            <a href="{{ route('producciones.index') }}" class="role-metric admin-metric--prod dash-kpi--blue text-decoration-none">
            ...
            <a href="{{ route('insumos.index') }}" class="role-metric admin-metric--inv dash-kpi--amber text-decoration-none">
            ...
            <a href="{{ route('logistica.asignaciones.listado') }}" class="role-metric admin-metric--transporte dash-kpi--teal text-decoration-none">
