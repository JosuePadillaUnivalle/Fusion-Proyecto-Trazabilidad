...
.usu-index-filtros .selector-catalogo-wrapper.form-group { margin-bottom: 0; }
.usu-index-filtros .selector-catalogo-wrapper > label {
    font-size: 0.72rem;
    font-weight: 700;
    text-transform: uppercase;
    letter-spacing: 0.04em;
...
.usu-index-lotes-link:hover {
    background: #d1fae5;
    text-decoration: none;
    transform: translateY(-1px);
}
.usu-index-lotes-link strong { color: #166534; }
.usu-index-actions {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    ...
    <div class="usu-index-card">
        ...
        <div class="usu-index-filtros">
            <form method="GET" action="{{ route('gestion.index') }}">
                @php
                    $colBuscar = $modoJefe
                        ? ($lotes->isNotEmpty() ? 'col-lg-4' : 'col-lg-8')
                        : 'col-lg-2';
                    $colAcciones = $modoJefe ? 'col-lg-4' : 'col-lg-3';
                @endphp
                <div class="row align-items-end">
                    <div class="{{ $colBuscar }} col-md-6 mb-2 mb-lg-0">
                    ...
                    @endif
                    <div class="{{ $colAcciones }} col-md-12 mb-2 mb-lg-0 usu-index-filtro-actions d-flex">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center usu-index-lotes-count">
                            @if($usuario->lotes_count > 0)
                                <a href="{{ route('gestion.show', $usuario) }}#lotes-responsable"
                                   class="usu-index-lotes-link" title="Ver lotes como responsable">
