...
@section('content')
        ...
        @if($pendientes->count() > 0 && ! request()->hasAny(['estado', 'q', 'fase_envio']))
        ...
        <div class="card card-outline card-success card-modulo-main elevation-1">
            <x-modulo-index-header
                ...
                filtros-target="#filtrosPedidosPlantaPanel"
            />

            <div id="filtrosPedidosPlantaPanel" class="filtros-panel collapse {{ request()->hasAny(['q', 'estado', 'fase_envio']) ? 'show' : '' }}">
                <form method="GET" action="{{ route('agricola.pedidos.index') }}">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-6 mb-2">
                            ...
                            <select name="fase_envio" class="form-control form-control-sm">
                    ...
                    <x-filtros-form-actions
                        :limpiar-url="route('agricola.pedidos.index', ['filtros_abiertos' => 1])"
                        :resultados="request()->hasAny(['q', 'estado', 'fase_envio']) ? $pedidos->count() : null"
                    />
                </form>
            </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-5 text-muted">
                                        ...
                                        @if(request()->hasAny(['q', 'estado', 'fase_envio']))
